...
# 修改评价指标相关配置
val_evaluator = dict(ann_file=data_root + 'annotation_coco_val.json')
test_evaluator = dict(ann_file=data_root + 'annotation_coco_test.json')
